...
// Tu código acá:
document.body.querySelector("#createdBy").innerHTML += "Micaela Diana Solórzano"
...
function buildToDos(toDos) {
  // Tu código acá:
  return toDos.map(function(todo, index) {return buildToDo(todo, index)})
  //OTRA FORMA
